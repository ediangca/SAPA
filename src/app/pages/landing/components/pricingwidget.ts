...
@Component({
    ...
    template: `
        <div id="pricing" class="py-6 px-6 lg:px-20 my-2 md:my-6">
            <div class="text-center mb-6" data-aos="fade-up" data-aos-easing="linear"
      data-aos-duration="500">
            ...
            <div class="grid grid-cols-12 gap-4 justify-between mt-20 md:mt-0" data-aos="fade-up" data-aos-easing="linear"
      data-aos-duration="500">
