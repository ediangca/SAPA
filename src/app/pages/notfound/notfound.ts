        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <a href>
                <img
                    ...
                    alt="SAPA Logo"
                    class="w-28 sm:w-32 md:w-36 lg:w-40 h-auto
            ...
            <div
                ...
                <div
                    ...
                    <h1
                        class="text-surface-900 dark:text-surface-0 font-bold text-3xl lg:text-5xl mb-2">Not
                        Found</h1>
                    <div
                        class="text-surface-600 dark:text-surface-200 mb-8">Requested
                        resource is not available.</div>
                    <!-- <a routerLink="/"
                    ...
                    <a routerLink="/"
                        ...
                        <span class="ml-6 flex flex-col">
                            <span
                                class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Solution
                                Center</span>
                            <span
                    ...
                    <a routerLink="/"
                        ...
                        <span class="ml-6 flex flex-col">
                            <span
                                class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Permission
                                Manager</span>
                            <span
                                class="text-surface-600 dark:text-surface-200 lg:text-xl">Accumsan
