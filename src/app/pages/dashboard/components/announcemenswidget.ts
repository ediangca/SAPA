...
@Component({
    ...
    <div class="card"
        ...
        <!--  -->
        <div #scrollContainer
            class="card px-0! announcement bg-transparent overflow-auto bg-gray-50 rounded-xl"
            ...
            <div *ngFor="let post of posts"
                ...
                <!-- ACTION BAR -->
                <div
                    class="border-t border-gray-100 px-5 py-3 bg-gray-50 rounded-b-2xl">
                    ...
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <div class="flex gap-6">
                            ...
                            <button
                                ...
                                👍 <span>Like</span>
                                <span
                                    class="flex items-center gap-1 bg-blue-50 text-blue-600 text-xs px-3 py-1 rounded-full font-medium">
                                    {{ post.likeCount || 0 }}
                                </span>
                            </button>
