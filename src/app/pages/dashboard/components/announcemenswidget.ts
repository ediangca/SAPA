...
@Component({
    ...
    <div class="card h-[750px] overflow-auto p-4 bg-gray-50 rounded-xl">
    ...
    <div *ngFor="let post of posts" 
         class="mb-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
